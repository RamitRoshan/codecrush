// const Footer = () => {
//   return (
//     <footer className="footer footer-center bg-base-300 text-neutral-content p-4">
//       <aside>
//         <svg
//           width="50"
//           height="50"
...
//           <a
//             href="https://x.com/RamitRosha10031"
//             target="_blank"
...
const Footer = () => {
  return (
    <footer className="bg-base-300 text-neutral-content px-10 py-6">
